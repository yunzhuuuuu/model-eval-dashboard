...
- 2026-09-23: Aligned page headings with card width, kept desktop subtitles on one line, enlarged CSV examples with full-size links, and restored self-made versus LLM dataset guidance.
